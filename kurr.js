...
if(budy.includes('Nopal')){
cpref = `Hayo Ngomongin Nopal Official Ya Gw Bilangin Ah Aowkowk`
reply(cpref)
}
if(budy.includes('Assalamualaikum')){
cpref = `Waalaikumsalam Hay Saya Nopal Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('assalamualaikum')){
cpref = `Waalaikumsalam Hay Saya Nopal Botz Whatsapp Ketik .menu Untuk Mengakses`
...
cpref = `Hay Saya Nopal Botz Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('hai')){
cpref = `Hay Saya Nopal Botz Whatsapp Ketik .menu Untuk Mengakses`
...
case 'quotes2':
				...
				kurr.sendMessage(from, ''+tes+'\n\n_By : Nopal Official._', text, { quoted: mek })
				break
case 'afk':
                                        tels = body.slice(4)
                                        if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
...
case 'shota': 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/anime/shota?apikey=NisaaCantik`)
loli = await getBuffer(anu.result)
kurr.sendMessage(from, loli, image, {quoted: mek, caption: '*Nih Kak*'})
break
case 'kosonime': 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/anime/kusonime?search=planetarian&apikey=NisaaCantik`)
loli = await getBuffer(anu.result)
kurr.sendMessage(from, loli, image, {quoted: mek, caption: '*Nih Kak*'})
break
case 'cosplay': 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/anime/cosplay?apikey=NisaaCantik`)
loli = await getBuffer(anu.result)
kurr.sendMessage(from, loli, image, {quoted: mek, caption: '*Nih Kak*'})
break
case 'meme': 
...
case 'neko':
 if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
 sticWait(from)
 await getBuffer (`https://kurr-api.herokuapp.com/api/anime/neko?apikey=kurrxkey09`).then((gambar)=>{
...
case 'waifu':
 if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
 sticWait(from)
 await getBuffer (`https://apidhani.herokuapp.com/api/anime/waifu`).then((gambar)=>{
kurr.sendMessage(from, gambar, image, { quoted: ftrol })
})
break
case 'milf':
 if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
 sticWait(from)
 await getBuffer (`https://apidhani.herokuapp.com/api/anime/milf?apikey=NisaaCantik`).then((gambar)=>{
kurr.sendMessage(from, gambar, image, { quoted: ftrol })
})
break
case 'megumin':
 if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
 sticWait(from)
 await getBuffer (`https://kurr-api.herokuapp.com/api/anime/megumin?apikey=kurrxkey09`).then((gambar)=>{
kurr.sendMessage(from, gambar, image, { quoted: ftrol })
})
break
//══════════[ FITUR NSFW ]══════════//
...
//══════════[ FITUR MAKER ]══════════//
case 'blackpink': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/blackpink?apikey=NisaaCantik&text=&text=${teks}`)
black = await getBuffer(anu.result)
kurr.sendMessage(from, black, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'gradient': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/3d-gradient?apikey=NisaaCantik&text=${teks}`)
gradient = await getBuffer(anu.result)
kurr.sendMessage(from, gradient, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'naturalleaves': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/natural-leaves?apikey=NisaaCantik&text=${teks}`)
natural = await getBuffer(anu.result)
kurr.sendMessage(from, natural, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'dropwater': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/drop-water?apikey=NisaaCantik&text=${teks}`)
dropwater = await getBuffer(anu.result)
kurr.sendMessage(from, dropwater, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'pornhub':     
if (args.length < 1) return reply(`*Contoh : ${prefix + command} NopalOfficial*`)
var F = body.slice(8)
var F1 = F.split("&")[0];
var F2 = F.split("&")[1]; 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/porn-hub?apikey=NisaaCantik&text1=${F1}&text2=${F2}`)
...
var F2 = F.split("&")[1]; 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/logo-wolf2?apikey=NisaaCantik&text=${F1}&text2=${F2}`)
wolf1 = await getBuffer(anu.result)
kurr.sendMessage(from, wolf1, image, {caption: `*Nih kak dah jadi*`, quoted: mek})
break
case 'wolf2':   
if (args.length < 1) return reply(`*Contoh : ${prefix + command} Nopalofficial*`)
var F = body.slice(6)
...
var F2 = F.split("&")[1]; 
reply(mess.wait)
anu = await fetchJson(`https://apidhani.herokuapp.com/api/textpro/logo-wolf?apikey=NisaaCantik&text=${F1}&text2=${F2}`)
wolf2 = await getBuffer(anu.result)
kurr.sendMessage(from, wolf2, image, {caption: `*Nih kak dah jadi*`, quoted: mek})
break
case 'girlneko':    
if (args.length < 1) return reply(`*Contoh : ${prefix + command} Nopalofficial`)
var F = body.slice(9)
...
kurr.sendMessage(from, sadboy, image, {caption: `*Nih kak dah jadi*`, quoted: mek})
break
case 'kaneki': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
kaneki = await getBuffer(`https://apidhani.herokuapp.com/api/maker/kaneki?apikey=NisaaCantik&text=${teks}`)
kurr.sendMessage(from, kaneki, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'rem': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
rem = await getBuffer(`https://apidhani.herokuapp.com/api/maker/rem?apikey=NisaaCantik&text=${teks}`)
kurr.sendMessage(from, rem, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'lolimaker': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} NopalOfficial_`) 
teks = args.join(" ")
reply(mess.wait)
lolimaker = await getBuffer(`https://apidhani.herokuapp.com/api/maker/lolimaker?apikey=NisaaCantik&text=${teks}`)
kurr.sendMessage(from, lolimaker, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
case 'gura': 
if (args.length < 1) return reply(`*Teks nya mana?*\n_Contoh : ${prefix + command} Nopalofficial_`) 
teks = args.join(" ")
reply(mess.wait)
gura = await getBuffer(`https://apidhani.herokuapp.com/api/maker/gura?apikey=NisaaCantik&text=${teks}`)
kurr.sendMessage(from, gura, image, {quoted: mek, caption: '*Nih Kak Dah Jadi*'})
break
//══════════[ RANDOM TEXT ]══════════//
case 'pantun':
case 'katabijak':
...
break
 ...
 footerText: '*_© NopalBotz Officialゑ v.3.0_*',
...
╚═════════════════❍
 `
sendButLocation(from, `${menu}`, "*_© Nopal Officialゑ v.3.0_*", {jpegThumbnail:ofrply2,name:""}, [{buttonId:`info`,buttonText:{displayText:'INFO BOT'},type:1},{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
╚═════════════════❍    
 `
sendButLocation(from, `${menu}`, "*_© Nopal Officialゑ v.3.0_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
║┣❏ *${prefix}nsfw blowjob*
║┣❏ *${prefix}nsfw kuni*
║┣❏ *${prefix}nsfw futanari*
║┣❏ *${prefix}nsfw holo ero*
║┣❏ *${prefix}nsfw holo*
║┣❏ *${prefix}nsfw kemonomimi*
║┣❏ *${prefix}nsfw keta*
║┣❏ *${prefix}nsfw pussy art*
║┣❏ *${prefix}nsfw girl solo*
║┣❏ *${prefix}nsfw anal*
║┣❏ *${prefix}nsfw bj*
║┣❏ *${prefix}nsfw tits*
║┣❏ *${prefix}nsfw boobs*
║┣❏ *${prefix}nsfw cumsluts*
║┣❏ *${prefix}nsfw ero yuri*
║┣❏ *${prefix}nsfwfeet*
║┣❏ *${prefix}nsfwfemdom*
║┣❏ *${prefix}nsfwfeet*
║┣❏ *${prefix}nsfwcumarts*
...
if (!isRegistered) return reply(`daftar dlu om/tante ketik .verify`)
              ...
              buttonsMessage = {footerText:'✗Nopal Official✗', imageMessage: imageMsg,
...
case 'memeindo':
  if (!isRegistered) return reply(`daftar dlu om/tante ketik .verify`)
              buff = await getBuffer(`https://app.ardyapi.rf.gd/api/random/darkjokes?apikey=kxrNC`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗Nopal Official✗', imageMessage: imageMsg,
              contentText:`Nih Om`,buttons,headerType:4}
...
╚═════════════════❍ 
`
sendButLocation(from, `${menu}`, "*_© Nopal Officialゑ v.3.0_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'STORE BOT'},type:1},{buttonId:`sewabot`,buttonText:{displayText:'SEWABOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
case 'catlog': 
  if (!isRegistered) return reply(`daftar dlu om/tante ketik .verify`)
                ...
                nama = ' ゑwelcome to Nopal Officialゑ '
       ownerJid = "6285773557984@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menunya = `*Nopal Official Melayani Jasa Pembuatan Vps/Rdp*
...
imageMessage: mhan.message.imageMessage,
contentText: `${menunya}`,
footerText: `Nopal Officialゑ v.3.0`,
buttons: gbutsan,
headerType: 4
}
...
break
 ...
 footerText: '*_© Nopal Officialゑ v.3.0_*',
...
MINAT HUB https://wa.me/6289522632509/?text=.sewabot
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `Nopal Officialゑ v.3.0`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `Script Nopal Officialゑ v.3.0`,
...
case 'blackpink':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} Nopal Botz`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api-alphabot.herokuapp.com/api/textpro/blackpink? text=&apikey=Alphabot&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Nopal Ofc`, quoted : ftrol})
                    })
                    break
case 'neon':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
 ...
 `
sendButLocation(from, `${menu}`, "*_© Nopal Officialゑ v.3.0_*", {jpegThumbnail:ofrply3,name:""}, [{buttonId:`owner`,buttonText:{displayText:'OWNER THIS BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
